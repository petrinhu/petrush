...
| ASM-NET | W26 | ASM | netcom scan; -up EPERM sem CAP. EXECUTAR TESTE [`ctest -R asm_netcom`] [NA FATIA] | Média | ASM-ABI, I18N-GETTEXT | Alta | 0.38 | 🔍 Pendente verificação | netcom_scan.S→impl C; -wifi/-eth/-bt; -up/-down helpers; EPERM sem CAP; ctest asm_netcom+eperm; Docker fedora:44; sem push; sem 4755; plugin_load intocado |
