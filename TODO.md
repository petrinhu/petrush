...
| PLG-ABI | W23 | Plugins | `plugins/abi.h` C11. Sem dlopen no main. EXECUTAR TESTE [ABI major=1] [NA FATIA] | Alta | ASM-ABI | Baixa | 4.33 | 🔍 Pendente verificação | abi.h C11 major=1 minor=0 query/init/cmd/fini + vtable; smoke plg-abi-header.sh + target plugin_abi; main sem dlopen; Docker fedora:44 clang OK; sem 4755; sem push; UX-25 intocado |
...
| ASM-I64 | W23 | ASM | `petrush_parse_i64`. EXECUTAR TESTE [`ctest -R asm_parse_i64`] [NA FATIA] | Alta | ASM-ABI | Baixa | 2.67 | 🔍 Pendente verificação | parse_i64.S decimal +/- INT64_MIN/MAX sem overflow UB; ctest asm_parse_i64 16/16; Docker fedora:44 clang OK; sem push; sem 4755 |
...
| ASM-PGID | W23 | ASM | `petrush_job_setpgid`. EXECUTAR TESTE [`ctest -R test_job`] [NA FATIA] | Alta | ASM-ABI | Baixa | 2.67 | 🔍 Pendente verificação | job_setpgid.S SYS_setpgid=109; 0/-errno; process+dispatcher; ctest asm_job_setpgid 6/6 + test_job; Docker fedora:44 clang OK; sem push; sem 4755 |
| ASM-CRC | W23 | ASM | `petrush_crc32` IEEE. EXECUTAR TESTE [`ctest -R asm_crc32`] [NA FATIA] | Média | ASM-ABI | Baixa | 2.50 | 🔍 Pendente verificação | crc32.S IEEE 0xEDB88320 table; vetor 123456789→0xCBF43926; ctest asm_crc32 8/8; Docker fedora:44 clang OK; sem push; sem 4755 |
...
| TST-ASM | W23 | Testes | Harness `tests/asm/` Docker. EXECUTAR TESTE [`ctest -R asm_`] [NO FIM W23] | Alta | ASM-00 | Alta | 1.00 | 🔍 Pendente verificação | ctest -R asm_ 10/10 Sanitize+Release clang Docker fedora:44; ASan static OK; sem 4755; sem push; rel. docs/memory/tst-asm.md |
...
| ASM-TTY | W24 | ASM | `petrush_tty_mode`. PTY no container. EXECUTAR TESTE [`ctest -R asm_tty`] [NA FATIA] | Alta | ASM-ABI | Média | 1.60 | 🔍 Pendente verificação | tty_mode.S TCGETS/TCSETSF RAW/COOKED; 0/-errno; nao-TTY=-ENOTTY; ctest asm_tty 5/5 PTY; Docker fedora:44 clang OK; sem push; sem 4755 |
| CXX-00 | W24 | Build | Alvo configsh C++23, petrush sem libstdc++. EXECUTAR TESTE [ldd] [NA FATIA] | Alta | ASM-00 | Média | 1.60 | 🔍 Pendente verificação | configsh C++23 -fno-exceptions -fno-rtti; liga tty_mode+utf8_width; stub help exit 0; ldd libstdc++ so em configsh; smoke cxx00-ldd; Docker fedora:44 PASS; sem push; sem 4755 |
| DOC-ARCH | W24 | Docs | architecture.md stack tripla. EXECUTAR TESTE [prosa↔pastas] [NA FATIA] | Baixa | ADR-CXXASM | Baixa | 1.50 | 🔍 Pendente verificação | prosa↔pastas C23/C++23/ASM+configsh+10 ilhas+plugins ABI; sem C++ no parser; ADR-001; sem push 2026-08-23 |
...
| I18N-GETTEXT | W24 | i18n | po/ pt_BR es_419 en. EXECUTAR TESTE [msgfmt] [NA FATIA] | Média | ASM-00 | Alta | 0.63 | 🔍 Pendente verificação | po/ en+pt_BR+es_419 (msgid=en); i18n.c bindtextdomain; msgfmt CMake petrush_mo; smoke i18n-gettext + target i18n_gettext; Docker fedora:44 PASS; ASM sem gettext; sem 4755; sem push |
| PLG-LOAD | W25 | Foundation | loader XDG + SHA-256. EXECUTAR TESTE [`ctest -R plugin_`] [NA FATIA] | Alta | PLG-NARC, ASM-CRC, ASM-MEMEQ, ASM-HASH | Alta | 1.63 | 🔍 Pendente verificação | plugin_load.c XDG+PETRUSH_PLUGIN_PATH+SHA-256+ww+allow; dlopen pos-checks; pudod sem .so; dlsym via memcpy/union (QA -Wpedantic); ctest plugin_ + plugin_pudod_no_dl; Docker fedora:44 gcc; sem 4755; sem push |
| CXX-TUI | W25 | Front | configsh TUI raw. EXECUTAR TESTE [configsh --dump] [NA FATIA] | Média | CXX-00, ASM-TTY, ASM-UTF8 | Alta | 0.63 | 🔍 Pendente verificação | TUI raw ANSI sem ncurses; --section/--dump/--check; XDG config.ini; smoke cxx-tui + PTY fedora:44 PASS; sem push; sem 4755 |
| ASM-WAI | W25 | ASM | builtin wai (sysfs). EXECUTAR TESTE [`ctest -R asm_wai`] [NA FATIA] | Média | ASM-ABI, I18N-GETTEXT | Alta | 0.63 | 🔍 Pendente verificação | wai_scan.S→impl C; flags -disk…-board; overlay sysfs; sem serial/uuid; ctest asm_wai 11/11; Docker fedora:44 clang OK; sem push; sem 4755 |
| TST-PLG | W26 | Testes | ww/hash/ABI. EXECUTAR TESTE [`ctest -R plugin_`] [NA FATIA] | Alta | PLG-LOAD | Média | 2.60 | 🔍 Pendente verificação | ctest -R plugin_ 2/2 + acutest 13/13; REQ ww/hash/ABI/path_fora/dlopen-pos-allow; Docker fedora:44 gcc unpriv; mode 755 sem 4755; docs/memory/tst-plg.md; sem push |
| TST-CXX | W26 | Testes | configsh PTY. EXECUTAR TESTE [`ctest -R configsh`] [NA FATIA] | Média | CXX-TUI | Média | 1.00 | 🔍 Pendente verificação | add_test(NAME configsh)→cxx-tui.sh; ctest -R configsh host+Docker fedora:44 -t PASS (PTY python); mode 755 sem ncurses; docs/memory/tst-cxx.md; sem push; sem 4755; sem :0 |
| ASM-NET | W26 | ASM | netcom scan; -up EPERM sem CAP. EXECUTAR TESTE [`ctest -R asm_netcom`] [NA FATIA] | Média | ASM-ABI, I18N-GETTEXT | Alta | 0.38 | 🔍 Pendente verificação | netcom_scan.S→impl C; -wifi/-eth/-bt; -up/-down helpers; EPERM sem CAP; ctest asm_netcom+eperm; QA: RTA loop tipado (sem RTA_NEXT/-Wno-sign no produto); gcc F44 -Wconversion petrush PASS; sem push; sem 4755; plugin_load intocado |
| DOC-DIA-PT | W27 | Docs | Diátaxis pt-BR. EXECUTAR TESTE [4 tipos] [NA FATIA] | Média | CXX-TUI, ASM-WAI | Alta | 0.63 | 🔍 Pendente verificação | docs/diataxis/pt-BR: tutorial+how-to+reference+explanation; cobre wai/netcom/configsh/OSH-0/XDG; sem POSIX 100%; sem em-dash; sem push |
| DOC-DIA-EN | W28 | Docs | Diátaxis en. EXECUTAR TESTE [4 tipos] [NA FATIA] | Baixa | DOC-DIA-PT | Alta | 0.38 | 🔍 Pendente verificação | docs/diataxis/en: tutorial+how-to+reference+explanation; msgid EN; espelho pt-BR; cobre wai/netcom/configsh/OSH-0/XDG; sem POSIX 100%; sem em-dash; sem push |
| DOC-DIA-ES | W28 | Docs | Diátaxis es-419. EXECUTAR TESTE [4 tipos] [NA FATIA] | Baixa | DOC-DIA-PT | Alta | 0.38 | 🔍 Pendente verificação | docs/diataxis/es-419: tutorial+how-to+reference+explanation; espelho pt-BR; cobre wai/netcom/configsh/OSH-0/XDG; sem POSIX 100%; sem em-dash; sem push |
| GATE-CXXASM | W29 | Gate | ctest asm_/configsh/plugin_ Fedora 44. Sem tag. EXECUTAR TESTE [verify] [FIM W29] | Alta | ASM-00, ASM-ABI, ADR-CXXASM, ASM-CRC, ASM-MEMEQ, ASM-HASH, ASM-I64, ASM-GLOB, ASM-PGID, ASM-TTY, ASM-UTF8, CXX-00, CXX-TUI, ASM-WAI, PLG-ABI, PLG-NARC, PLG-LOAD, ASM-NET, I18N-GETTEXT, DOC-DIA-PT, DOC-DIA-EN, DOC-DIA-ES, TST-ASM, TST-CXX, TST-PLG, DOC-ARCH | Baixa | 4.00 | 🔍 Pendente verificação | ctest filter asm_/configsh/plugin_ 13/13 Sanitize+Release clang Docker fedora:44; ASan static OK; mode 755 sem 4755; sem :0; sem tag; sem push; rel. docs/memory/gate-cxxasm.md |
