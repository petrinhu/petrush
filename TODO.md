...
| SEC-12 | W16 | Segurança | Recusar shell genérico na allow-list (basename sh/bash/dash/ash/busybox) após realpath. Ver [`docs/auditoria/aud-report.md`](docs/auditoria/aud-report.md). | Alta | SEC-11 | Média | ⏳ Pendente | — |
