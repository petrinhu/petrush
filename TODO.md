...
|----------|----------|-----------------------------------------------------------------------------------|-------------------------------|----------------------|-------------|
| PR-11    | 2.1      | `.github/workflows/ci.yml` (Fedora 44 container + clang/gcc matrix)   | Caetano / devops light        | Com 2.2              | 🔍 Migrado Ubuntu→**Fedora 44** (espelha host); job experimental F45. Fix newline-eof + format-truncation. |
